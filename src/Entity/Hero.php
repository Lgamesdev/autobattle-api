...
class UserCharacter
{
    ...
    public function addFighterDefeated(): void
    {
        $this->fighterDefeated++;
    }

    public function getFighterDefeated(): int
    {
        return $this->fighterDefeated;
    }
